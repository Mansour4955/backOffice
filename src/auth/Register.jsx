...
const Register = () => {
  ...
  const handleSubmitForm = (e) => {
    ...
    if (
      ...
      axios
        .post("http://localhost:5199/api/Users", {
          Email: email,
          Password: password,
          Name: username,
        })
      ...
      if (!username) {
        ...
        setErrorUsername("Username should have at least 3 characters");
      }
    }
  };
  return (
    <div className="flex justify-center my-10  gap-x-10 pt-5 px-4 bg-white_color h-[76vh] max-h-[76vh]">
        ...
        <div className="flex justify-center p-4 bg-white">
          <div className="min-h-[60vh] w-full flex flex-col gap-10 items-center justify-center p-4 shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] rounded-lg">
            <div className="flex flex-col gap-6">
              <h2 className="text-2xl text-bluebg-blue-600 font-semibold">
                Register:
              </h2>
              <form
